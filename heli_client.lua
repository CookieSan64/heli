...
local buzzard_hash = GetHashKey("buzzard")
...
function IsPlayerInPolmav()
    ...
    return IsVehicleModel(vehicle, polmav_hash) or
        IsVehicleModel(vehicle, maverick_hash) or
        IsVehicleModel(vehicle, frogger_hash) or
		IsVehicleModel(vehicle, frogger2_hash) or
        IsVehicleModel(vehicle, buzzard_hash) or
        IsVehicleModel(vehicle, buzzard2_hash)
end
